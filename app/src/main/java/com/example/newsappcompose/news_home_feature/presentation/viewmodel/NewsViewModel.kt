package com.example.newsappcompose.news_home_feature.presentation.viewmodel
...
@HiltViewModel
class NewsViewModel @Inject constructor(private val getNews: NewsUseCase) : ViewModel() {
